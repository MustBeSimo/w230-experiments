      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="flex gap-4 overflow-x-auto pb-2">
                {referenceImages.map((img, idx) => (
                    <div key={idx} className="relative flex-shrink-0 w-24 h-24 rounded-xl overflow-hidden border border-beige-200 group">
                        ...
                        <button onClick={() => handlers.onRemoveReference(idx)} className="absolute inset-0 bg-black/40 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
          ...
          <div className="md:col-span-2 lg:col-span-4 bg-white border border-beige-300 rounded-3xl p-6 flex flex-col gap-4">
            <div className="flex justify-between items-center">
                ...
                <button onClick={addCharacter} className="text-[10px] font-bold uppercase text-beige-400 hover:text-terracotta flex items-center gap-1">
