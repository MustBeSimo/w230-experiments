    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 bg-beige-900/60 backdrop-blur-sm">
      <div className="bg-white border border-beige-200 rounded-[2.5rem] w-full max-w-2xl p-8 shadow-2xl space-y-6 overflow-hidden relative">
          ...
          <div className="flex justify-between items-center">
            ...
            <button onClick={onClose} disabled={isRefining} className="w-10 h-10 rounded-full bg-beige-100 hover:bg-beige-200 flex items-center justify-center transition-colors disabled:opacity-50">
          ...
          <div className="flex gap-4">
              <Button onClick={onClose} variant="secondary" disabled={isRefining} className="flex-1 py-5 rounded-2xl font-bold">Cancel</Button>
              <Button onClick={handleApply} disabled={isRefining || !editPrompt.trim()} className="flex-[2] py-5 rounded-2xl font-bold text-lg">
